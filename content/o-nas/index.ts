 ...
 * that caption reads as the other not existing. It also wants to be a portrait
 * rather than a landscape crop of one — the frame is tall, and a wide
 * photograph put into it loses either the faces or the work behind them. Its
