 ...
 *
 * `<` is escaped on the way in. The site's own copy contains none (it is
 * Polish prose written in this repo), but the failure mode is out of all
 * proportion to the cost of preventing it. A `</script` appearing
