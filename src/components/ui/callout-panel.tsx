 ...
 *
 * It owns the two colour classes and nothing else. Every panel on the site
 * differs in element, width, alignment and padding, because each one is
 * spaced against a different page: the closing invitation on the homepage
 ...
 * not built from this. There the border colour signals that the message got
 * out, and a `tone` prop would file it next to cosmetic decisions.
 */
